...
- [ ] User accounts with Google + Apple login (`django-allauth`)
- [ ] Product catalog (CRUD via Django admin)
- [ ] Product listing page with category filter
- [ ] Product detail page with image gallery + size picker
- [ ] Cart (session-based for guests, persistent for logged-in users)
- [ ] Stripe Checkout integration
- [ ] Order model + webhook handler
- [ ] Order confirmation page + email
- [ ] Shipping: pickup at training + flat-rate standard
- [ ] Basic order history page
- [ ] Admin: manage products, view orders, update status
